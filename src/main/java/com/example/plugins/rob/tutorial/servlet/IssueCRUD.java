package com.example.plugins.rob.tutorial.servlet;
...
public class IssueCRUD extends HttpServlet {
    ...
    private List<Issue> getIssues(HttpServletRequest req) {
        ...
        // Our JQL clause is simple project="COMPLAIN"
        com.atlassian.query.Query query = jqlClauseBuilder.project("COMPLAIN").buildQuery();
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("y".equals(req.getParameter("edit"))) {
            ...
            // We hard-code the project name to be the project with the COMPLAIN key
            Project project = projectService.getProjectByKey(user, "COMPLAIN").getProject();
